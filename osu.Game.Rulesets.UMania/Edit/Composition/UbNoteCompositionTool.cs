...
{
    public class UbNoteCompositionTool : UbBaseCompositionTool
    {
        public UbNoteCompositionTool(string name, UbIconType icon, List<int> columns, List<string> hitSamples, string bank = HitSampleInfo.BANK_NORMAL)
