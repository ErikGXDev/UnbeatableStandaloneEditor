...
namespace osu.Game.Rulesets.UMania.Skinning
{
    public class ManiaSkinConfigurationLookup
    {
        ...
        /// May be null if the configuration does not apply to a <see cref="SquareGraph.Column"/>.
        ...
        /// <param name="columnIndex">The intended <see cref="SquareGraph.Column"/> index for the configuration. May be null if the configuration does not apply to a <see cref="SquareGraph.Column"/>.</param>
